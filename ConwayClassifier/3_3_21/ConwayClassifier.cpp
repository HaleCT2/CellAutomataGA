...
// ToDo
// % change of cells? (between gens)
// dead/alive ratio (static analysis)
// active cell ratio (between gens)
//  (cell that has not been dead for n generations)
// largest rectangle ratio (static)
// we could be making up our own tbh
