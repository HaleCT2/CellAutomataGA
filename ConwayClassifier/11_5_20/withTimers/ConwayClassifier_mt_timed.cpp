...
ConwayClassifier::ConwayClassifier(const std::string& dataDirPath,
    ...
    std::cout << "extractRule time: " << duration.count() << "ms" << std::endl;
    ...
    if (this->classNum != 1) {
        ...
        std::cout << "populateIStreamVec time: " << duration.count() << "ms" << std::endl;
        ...
        stop = std::chrono::high_resolution_clock::now();
        duration = std::chrono::duration_cast<std::chrono::milliseconds>(stop - start);
        std::cout << "calcBoardSpecs time: " << duration.count() << "ms" << std::endl;
        ...
        stop = std::chrono::high_resolution_clock::now();
        duration = std::chrono::duration_cast<std::chrono::milliseconds>(stop - start);
        std::cout << "initializeGameBoard time: " << duration.count() << "ms" << std::endl;

        start = std::chrono::high_resolution_clock::now();
        fillBoard(fileStreams, maxThrNum);
        stop = std::chrono::high_resolution_clock::now();
        duration = std::chrono::duration_cast<std::chrono::milliseconds>(stop - start);
        std::cout << "fillBoard time: " << duration.count() << "ms" << std::endl;
        ...
        stop = std::chrono::high_resolution_clock::now();
        duration = std::chrono::duration_cast<std::chrono::milliseconds>(stop - start);
        std::cout << "deallocateIfstreams time: " << duration.count() << "ms" << std::endl;
    } else {
        this->x = 0;
        this->y = 0;
        this->width = 0;
